...
COCO_CATEGORIES = [*T1_CLASS_NAMES, *T2_CLASS_NAMES, *T3_CLASS_NAMES, *T4_CLASS_NAMES]

COCO_BASE_CATEGORIES = {
    "t1" : T1_CLASS_NAMES,
    "t2" : T1_CLASS_NAMES,
    "t2_ft" : T1_CLASS_NAMES,
    "t3" : T1_CLASS_NAMES,
    "t3_ft" : T1_CLASS_NAMES,
    "t4" : T1_CLASS_NAMES,
    "t4_ft" : T1_CLASS_NAMES,
}
COCO_NOVEL_CATEGORIES = {
    "t1" : T1_CLASS_NAMES,
    "t2" : T2_CLASS_NAMES,
    "t2_ft" : T1_CLASS_NAMES + T2_CLASS_NAMES,
    "t3" : T3_CLASS_NAMES,
    "t3_ft" : T1_CLASS_NAMES + T2_CLASS_NAMES + T3_CLASS_NAMES,
    "t4" : T4_CLASS_NAMES,
    "t4_ft" : T1_CLASS_NAMES + T2_CLASS_NAMES + T3_CLASS_NAMES + T4_CLASS_NAMES,
}
